				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-header">
							<i class="fas fa-table me-1"></i> Auto Label
						</div>
						<div class="card-body">
							<c:if test="${empty mvo}">
								<p>"<a href="${contextPath}/">로그인</a> 하세요."</p>
                            </c:if>
									...
									<tbody>
										...
										<c:forEach var="vo" items="${list}" varStatus="s">
											<tr>
												<td>${s.count}</td>
												<td>
													<img class="pic_size" src="${contextPath}/resources/images/${vo.image_path}" style="cursor:pointer;" onclick="doImgPop(src)"/>
												</td>
												<td>
													<img class="pic_size" src="${contextPath}/resources/images/${vo.result_path}" style="cursor:pointer;" onclick="doImgPop(src)"/>
												</td>
