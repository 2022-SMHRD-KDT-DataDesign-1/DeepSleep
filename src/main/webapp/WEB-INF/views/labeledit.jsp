		...
		<ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
			<li class="nav-item dropdown"><a
				...
				<ul class="dropdown-menu dropdown-menu-end navuserSub"
					...
					<li><a class="dropdown-item" href="${contextPath}/index"><i
							class="fa-regular fa-hard-drive"></i> 보관함</a></li>

					<li><hr class="dropdown-divider" /></li>
					<li><a class="dropdown-item" href="${contextPath}/logout.do"><i
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-body">라벨링이 잘못된 이미지를 선택하고 라벨을 수정해주세요. 수정된
							데이터는 관리자에게 전송됩니다.</div>
					</div>
					<div class="card mb-4">
						...
						<form action="${contextPath}/downLoad.do">
							<div class="card-body" id="upload">
								...
								<div class="btnsty">
									<button type="button" class="btn btn-outline-primary" id="key1"
										style="color: #fff; border-color: #fff;">수정 키워드</button>
